...
@Component({
  selector: 'app-busqueda-figuritas-repetidas',
  templateUrl: './busqueda-figuritas-repetidas.component.html',
  styleUrls: ['./busqueda-figuritas-repetidas.component.css'],
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class BusquedaFiguritasRepetidasComponent extends BusquedaFiguritas {
  override pageSize: number = 3

  override figuritaServiceCall(): Promise<Figurita[]> {
    return this.figuritaService.figuritasRepetidasParaAgregar(this.currUserID, this.filtrosAplicados())
  }
...
export class StubBusquedaFiguritasComponent extends BusquedaFiguritasRepetidasComponent {
